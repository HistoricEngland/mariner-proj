"""
Django settings for mariner_proj project.
"""
...
SECRET_KEY = "django-insecure-=x+r#i(%9n(&$i-r@^vt4%q!8@-exj$e3nu25o97o$2&sfu5ef"
...
# [{
#     'module': 'mariner_proj.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = "mariner_proj.wsgi.application"
...
CACHES = {
    "default": {
        # Setting to something other than DummyCache so that GitHub builds don't fail
        # See check_cache_backend() in apps.py for other options
        # Developing locally, you should use DummyCache and comment out RedisCache
